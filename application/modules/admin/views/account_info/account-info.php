		...
		<div class="kt-grid kt-grid--desktop kt-grid--ver kt-grid--ver-desktop kt-app">
					...
					<div class="kt-portlet__body">
						<ul class="kt-nav kt-nav--bolder kt-nav--fit-ver kt-nav--v4" role="tablist">
							<li class="kt-nav__item  active ">
								<a class="kt-nav__link active" href="<?= route('admin.my-account') ?>" role="tab">
							...
							<li class="kt-nav__item  ">
								<a class="kt-nav__link" href="<?= route('admin.change-password') ?>" role="tab">
			...
			<div class="kt-grid__item kt-grid__item--fluid kt-app__content">
				<div class="kt-portlet">
					...
					<form action="<?= route('admin.update-profile') ?>" method="post"  class="kt-form kt-form--label-right" id="kt_profile_form" enctype="multipart/form-data">
						<div class="kt-portlet__body">
							<div class="kt-section kt-section--first">
								<div class="kt-section__body">
									...
									<div class="form-group row">
										...
										<div class="col-lg-9 col-xl-6">
											<div class="kt-avatar kt-avatar--outline kt-avatar--circle-" id="kt_profile_avatar">
												<div class="kt-avatar__holder" style="background-image: url('<?= base_url() . 'uploads/admin/' . $adminInfo['avatar'] ?>');"></div>
												<label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="Change avatar">
													<i class="fa fa-pen"></i>
													<input type="file" name="avatarfile" accept=".png, .jpg, .jpeg">
												</label>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9 col-xl-6">
											<input class="form-control <?= isset($errors['fullname']) ? 'is-invalid' : '' ?>" name="fullname" type="text" value="<?= $adminInfo['fullname'] ?>">
											<div class="invalid-feedback"><?= !empty($errors['fullname']) ? $errors['fullname'] : '' ?></div>
										</div>
									</div>
														<!-- <div class="form-group row">
														...
														<div class="form-group row">
															...
															<div class="col-lg-9 col-xl-6">
																<div class="input-group">
																	...
																	<input type="text" name="phone" class="form-control <?= isset($errors['phone']) ? 'is-invalid' : '' ?>" value="<?= $adminInfo['phone'] ?>" placeholder="Phone" aria-describedby="basic-addon1">
																	<div class="invalid-feedback"><?= !empty($errors['phone']) ? $errors['phone'] : '' ?></div>
																</div>
														...
														<div class="form-group row">
															...
															<div class="col-lg-9 col-xl-6">
																<div class="input-group">
																	...
																	<input type="text" class="form-control" value="<?= $adminInfo['email'] ?>" placeholder="Email" aria-describedby="basic-addon1" disabled>
																</div>
															</div>
														</div>
														<div class="form-group form-group-last row">
															...
															<div class="col-lg-9 col-xl-6">
																<div class="input-group">
																	<input type="text" name="address" class="form-control <?= isset($errors['address']) ? 'is-invalid' : '' ?>" placeholder="Address" value="<?= $adminInfo['address'] ?>">
																	<div class="invalid-feedback"><?= !empty($errors['address']) ? $errors['address'] : '' ?></div>
