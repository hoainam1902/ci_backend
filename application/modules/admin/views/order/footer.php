...
<script type="text/javascript">
	var getOrderURL = '<?= route('admin.api.order') ?>';
</script>
<!-- end::Global Config -->
...
<script src="assets/js/pages/components/keen-datatable/advanced/custom-column-rendering.js" type="text/javascript"></script>
