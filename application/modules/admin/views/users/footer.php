...
<script type="text/javascript">
	var getUsersURL = '<?= route('admin.api.users') ?>';
</script>
<!-- end::Global Config -->
...
<script src="assets/js/pages/components/keen-datatable/advanced/users-column-rendering.js" type="text/javascript"></script>
