			...
			<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
				<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
					<ul class="kt-menu__nav ">
						...
						<li class="kt-menu__item kt-menu__item--submenu <?= isCurrentURLMathWith('admin.order') ? 'kt-menu__item--open' : '' ?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon flaticon-calendar"></i><span class="kt-menu__link-text">Order</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
							<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
								<ul class="kt-menu__subnav">
									
									<li class="kt-menu__item <?= isCurrentURLMathWith('admin.order') ? 'kt-menu__item--active' : '' ?>" aria-haspopup="true"><a href="<?= route('admin/order') ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">My Order</span></a></li>
									
								</ul>
							</div>
						</li>
						<li class="kt-menu__item  kt-menu__item--submenu <?= (isCurrentURLMathWith('admin.my-account') || isCurrentURLMathWith('admin.change-password')) ? 'kt-menu__item--open' : '' ?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon flaticon-diagram"></i><span class="kt-menu__link-text">My Account</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
							<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
								<ul class="kt-menu__subnav">
									...
									<li class="kt-menu__item <?= isCurrentURLMathWith('admin.my-account') ? 'kt-menu__item--active' : '' ?>" aria-haspopup="true"><a href="<?= route('admin/my-account') ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Account Info</span></a></li>
									<li class="kt-menu__item <?= isCurrentURLMathWith('admin.change-password') ? 'kt-menu__item--active' : '' ?>" aria-haspopup="true"><a href="<?= route('admin/change-password') ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Change Password</span></a></li>
									
								</ul>
							</div>
						</li>
						<li class="kt-menu__item  kt-menu__item--submenu <?= (isCurrentURLMathWith('admin.users') || isCurrentURLMathWith('admin.users.edit')) ? 'kt-menu__item--open' : '' ?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon flaticon-diagram"></i><span class="kt-menu__link-text">My Account</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
							<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
								<ul class="kt-menu__subnav">
									<li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span class="kt-menu__link"><span class="kt-menu__link-text">User Manager</span></span></li>
									<li class="kt-menu__item <?= isCurrentURLMathWith('admin.users') ? 'kt-menu__item--active' : '' ?>" aria-haspopup="true"><a href="<?= route('admin/users') ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">All User</span></a></li>
								</ul>
							</div>
						</li>
					</ul>
								...
								<div class="kt-user-card kt-margin-b-40 kt-margin-b-30-tablet-and-mobile" style="background-image: url(assets/media/misc/head_bg_sm.jpg)">
									<div class="kt-user-card__wrapper">
										...
										<div class="kt-user-card__details">
											<div class="kt-user-card__name"><?= $_SESSION['adminInfo']['fullname'] ?></div>
											<div class="kt-user-card__position"><?= $_SESSION['adminInfo']['email'] ?></div>
										</div>
									</div>
								</div>
								<ul class="kt-nav kt-margin-b-10">
									<li class="kt-nav__item">
										<a href="<?= route('admin.my-account') ?>" class="kt-nav__link">
									...
									<li class="kt-nav__custom kt-space-between">
										<a href="<?= route('admin.logout') ?>" target="_blank" class="btn btn-label-brand btn-upper btn-sm btn-bold">Sign Out</a>
