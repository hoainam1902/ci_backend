		...
		<div class="kt-grid kt-grid--desktop kt-grid--ver kt-grid--ver-desktop kt-app">
			...
			<div class="kt-grid__item kt-grid__item--fluid kt-app__content">
				<div class="kt-portlet">
					...
					<form method="post" class="kt-form kt-form--label-right" id="kt_profile_form">
						<div class="kt-portlet__body">
							<div class="kt-section kt-section--first">
								<div class="kt-section__body">
									<div class="alert alert-solid-danger alert-bold fade show kt-margin-t-20 kt-margin-b-40" role="alert">
										<div class="alert-icon"><i class="fa fa-exclamation-triangle"></i></div>
										<div class="alert-text"> Nen chon mat khau manh </br> Mat khau tren 8 ky tu (Cang dai cang tot) 
										</br>Bao gom chu thuong chu hoa so ky tu dac biet</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9 col-xl-6">
											<input type="password" name="current-password" class="form-control <?= isset($errors['current-password']) ? 'is-invalid' : '' ?>" value="" placeholder="Current password">
											<div class="invalid-feedback"><?= !empty($errors['current-password']) ? $errors['current-password'] : '' ?></div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9 col-xl-6">
											<input type="password" name="password" class="form-control <?= isset($errors['password']) ? 'is-invalid' : '' ?>" value="" placeholder="New password">
											<div class="invalid-feedback"><?= !empty($errors['password']) ? $errors['password'] : '' ?></div>
										</div>
									</div>
									<div class="form-group form-group-last row">
										<label class="col-xl-3 col-lg-3 col-form-label">Verify Password</label>
										<div class="col-lg-9 col-xl-6">
											<input type="password" name="re-password" class="form-control <?= isset($errors['re-password']) ? 'is-invalid' : '' ?>" value="" placeholder="Verify password">
											<div class="invalid-feedback"><?= !empty($errors['re-password']) ? $errors['re-password'] : '' ?></div>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="kt-form__actions">
								<div class="row">
									...
									<div class="col-lg-9 col-xl-9">
										...
										<a href="<?= route('user.change-password') ?>" class="btn btn-secondary">Cancel</a>
									</div>
								</div>
							</div>
						</div>
