...
<script src="assets/js/pages/components/datatables/basic/paginations.js" type="text/javascript"></script> -->


<script src="assets/js/pages/components/keen-datatable/advanced/modal-custom.js" type="text/javascript"></script>
		<!--end::Page Scripts