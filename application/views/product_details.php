                        ...
                        <div class="single_product_desc">
                            ...
                            <form class="cart clearfix" method="post" action="#">
                                <div class="cart-btn d-flex mb-50">
                                    <input type="number" name="id" id="id" hidden="true" value="<?= $product->id ?>">
                                    <p>Qty</p>
                                    <div class="quantity">
                                ...
                                <button type="submit" id="btnAddCart" name="addtocart" value="5" class="btn amado-btn">Add to cart</button>
                            </form>
